...
public class ComplexMapExample {
    ...
    public static void main(String[] args) {                // Ale byków nawalone w tłumaczeniu i przykładach Kodilli :D
        ...
        for (Map.Entry<Student, Grades> studentEntry : school.entrySet()) {
            System.out.println(studentEntry.getKey().getFirstname() + ", average: " + studentEntry.getValue().getAverage() + studentEntry.getValue().getAverage());
        }
    }
}
